...
void Student::SetDaysInCourses(int daysCourse1, int daysCourse2, int daysCourse3) {
	daysInCourses[0] = daysCourse1;
	daysInCourses[1] = daysCourse2;
	daysInCourses[2] = daysCourse3;
}
...
void Student::Print() const {
	...
	string daysInfo = to_string(daysInCourses[0]) + ", " + to_string(daysInCourses[1]) + ", and" + to_string(daysInCourses[2]) + " days, respectively.";
